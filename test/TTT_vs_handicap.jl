...
composition = [ r.handicap<2 ? [[string(r.white)],[string(r.black)]] : [[string(r.white)],[string(r.black)]] for r in eachrow(data) ]
...
CSV.write("Trueskill_datos_con_handicap.csv", df; header=true)
